	...
	return func(ctx context.Context, conn *jsonrpc2.Conn, r *jsonrpc2.Request) (interface{}, *jsonrpc2.Error) {
		...
		case "$/cancelRequest":
			...
			if err := json.Unmarshal(*r.Params, &params); err != nil {
				return nil, jsonrpc2.NewError(jsonrpc2.CodeParseError, err.Error())
			}
		...
		case "window/showMessage":
			...
			if err := client.ShowMessage(ctx, &params); err != nil {
				return nil, jsonrpc2.NewError(jsonrpc2.CodeUnknownError, err.Error())
			}
			return nil, nil
		...
		case "workspace/workspaceFolders":
			if r.Params != nil {
				return nil, jsonrpc2.NewError(jsonrpc2.CodeInvalidParams, "Expected no params")
			}
